...
public class UserSearchCriteria {
    ...
    private String    q;               // free-text: email + firstName + lastName + rppsNumber
    private String    status;          // VerificationStatus enum name (doctors only)
    private String    bloodType;       // single value or comma-separated (patients only)
    private Integer   ageMin;
    private Integer   ageMax;
    private LocalDate signedUpSince;
    private LocalDate signedUpUntil;
